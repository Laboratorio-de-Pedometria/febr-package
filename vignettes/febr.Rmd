...
```{r, echo = TRUE, eval = FALSE}
pad <- febr::dictionary(variable = c("argila", "densidade", "carbono", "ph"))
```
...
```{r, echo = TRUE, eval = FALSE}
conj <- febr::identification(data.set = c("ctb0003", "ctb0036"))
```
...
```{r, echo = TRUE, eval = FALSE}
meta <- febr::metadata(data.set = c("ctb0003", "ctb0036"))
```
...
```{r, echo = TRUE, eval = FALSE}
obs <- febr::observation(data.set = "ctb0003", variable = "taxon")
```
...
```{r, echo = TRUE, eval = FALSE}
cam <- febr::layer(data.set = c("ctb0003", "ctb0036"), variable = c("argila", "carbono", "densidade"))
```
